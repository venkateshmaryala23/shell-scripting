...
if [ $COUNT -eq 0 ]; then
       aws ec2 run-instances --image-id ami-077fb3e62ddf0fa9a --instance-type t3.micro --security-group-ids sg-07624ce53dbdfb0f8 --tag-specifications "ResourceType=instance,Tags=[{Key=Name,Value=$1}]" | jq
else
